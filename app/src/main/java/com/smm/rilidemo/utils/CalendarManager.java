package com.smm.rilidemo.utils;
...
import com.smm.rilidemo.models.BaseCalendarEvent;
import com.smm.rilidemo.models.CalendarEvent;
import com.smm.rilidemo.models.DayItem;
import com.smm.rilidemo.models.MonthItem;
...
public class CalendarManager {
    ...
    public void buildCal(Calendar minDate, Calendar maxDate, Locale locale) {
        ...
        mMinCal.setFirstDayOfWeek(Calendar.MONDAY);
        mMaxCal.setFirstDayOfWeek(Calendar.MONDAY);
        mWeekCounter.setFirstDayOfWeek(Calendar.MONDAY);
            ...
            for (DayItem dayItem : weekItem.getDayItems()) {
                ...
                for (CalendarEvent event : eventList) {
                    ...
                    if (DateHelper.isBetweenInclusive(dayItem.getDate(), event.getStartTime(), event.getEndTime())) {
                        ...
                        dayInstance.setFirstDayOfWeek(Calendar.MONDAY);
