package com.smm.rilidemo.customview.calendar;
...
import com.smm.rilidemo.R;
import com.smm.rilidemo.customview.calendar.weekslist.WeekListView;
import com.smm.rilidemo.customview.calendar.weekslist.WeeksAdapter;
import com.smm.rilidemo.models.CalendarEvent;
import com.smm.rilidemo.models.DayItem;
import com.smm.rilidemo.models.WeekItem;
import com.smm.rilidemo.utils.BusProvider;
import com.smm.rilidemo.utils.CalendarManager;
import com.smm.rilidemo.utils.DateHelper;
...
//    private LinearLayout mDayNamesHeader;
    ...
    protected void onFinishInflate() {
        ...
        mListViewWeeks.setLayoutManager(layoutManager);
        //如果可以确定每个item的高度是固定的，设置这个选项可以提高性能
        mListViewWeeks.setHasFixedSize(true);
        //设置recyclerView的子动画
        mListViewWeeks.setItemAnimator(null);
        //设置是否能折叠recyclerView
        mListViewWeeks.setSnapEnabled(false);
...
//        }
    ...
    private void collapseCalendarView() {
        MarginLayoutParams layoutParams = (MarginLayoutParams) getLayoutParams();
        int height = (int) (getResources().getDimension(R.dimen.day_cell_height1));
        layoutParams.height = height;
        setLayoutParams(layoutParams);
    }
